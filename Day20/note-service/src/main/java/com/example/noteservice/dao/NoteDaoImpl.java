...
public class NoteDaoImpl implements NoteDao {
	...
	public NoteDaoImpl() {
		...
		/*  notes.add(new Note(9001, "Kumar", "Microservices","Best tool for orchestration")); 
		  notes.add(new Note(9002, "Anil", "Kafka","Best tool for large data")); 
		  notes.add(new Note(9003, "Pavan", "MySQL","Best tool for Database"));
		 */
	}
	...
	public List<Note> searchNote(int noteId) {
		...
		return result;
		/*List<Note> nts=notes.stream().filter(n->n.getNoteId()==noteId)
				.map(emp->emp)
